...
static inline void *ion_import_dma_buf(struct ion_client *client,
                                      struct dma_buf *dmabuf)
{
        return __ion_import_dma_buf(dmabuf);
}
...
static inline void *ion_import_dma_buf_fd(struct ion_client *client, int fd)
{
	return __ion_import_dma_buf_fd(fd);
}
